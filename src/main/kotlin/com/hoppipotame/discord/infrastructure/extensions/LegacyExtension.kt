...
class LegacyExtension(httpClient: HttpClient) : Extension {
    ...
    override suspend fun register(kord: Kord) {
        ...
        kord.on<MessageCreateEvent> {
            ...
            when (words.firstOrNull()) {
                "!search" -> search(words.drop(1).joinToString(" "), 10)
...
//    down/
    ...
    private suspend fun MessageCreateEvent.search(query: String, size: Int) {
        val searchTorrent: List<Torrent> = searchTorrentUserCase.searchTorrent(SearchQuery(query))
